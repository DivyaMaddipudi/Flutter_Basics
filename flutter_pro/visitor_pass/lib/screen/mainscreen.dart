      ...
      children: <Widget>[
        TextFormField(
          decoration: InputDecoration(
              labelText: "Visitor Name", hintText: "Enter Visitor's Name"),
          onSaved: (val) {
            name = val;
          },
        ...
        TextFormField(
          decoration: InputDecoration(
              labelText: "PhoneNumber", hintText: "Enter PhoneNumber"),
        ...
        TextFormField(
          decoration:
              InputDecoration(labelText: "Purpose", hintText: "Enter Purpose"),
          onSaved: (val) {
            purpose = val;
          },
        ...
        _imageFile == null
            ? Container()
            : Image.file(_imageFile, height: 300.0, width: 400.0),
        _imageFile == null
            ? Container()
            : SizedBox(
                width: 375,
